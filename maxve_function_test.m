% MAXVE function test
% Test script for the maximum volume ellipsoid function
...
%% Solve the maximum volume ellipsoid inscribed problem

% Maximum volume ellipse inscribed optimization
[E,xe] = maxve(A, b);

% Ellipse object definition
Elli = YSet(x, ((x-xe)'/(E*E'))*(x-xe) <= 1);
...
%%%%% End of maxve_function_test script %%%%%